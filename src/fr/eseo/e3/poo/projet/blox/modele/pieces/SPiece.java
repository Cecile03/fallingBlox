...
public class SPiece extends Piece{
	...
	/* Constructeur */
	public SPiece(Coordonnees c, Couleur co) {
		super(c, co);
		setElements(c, co);
	}

	/**
	 * Methode protégé qui remplit la liste elements de la pièce en forme de S avec
	 * quatre éléments
	 * 
	...
	protected void setElements(Coordonnees c, Couleur co) {
		...
		Coordonnees hautDroite = new Coordonnees(c.getAbscisse() + 1, c.getOrdonnee() - 1);
		...
		this.getElements().add(2, new Element(hautDroite, co));
